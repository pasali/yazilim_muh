...
<?php foreach($urunler as $urun){
	echo "
        ...
        <tr>
          <td class='image'>            <a href='#'><img style='width:50px;height:50px
' src='{base_url}images/urunler/150x150/".$urun['resim']."'/></a>
            </td>
  ...
  <div class="buttons">
    <div class="right"><a href="{base_url}index.php/sayfa/tamamlanan_alisverisler" class="button">Continue</a></div>
  </div>
    </div>
